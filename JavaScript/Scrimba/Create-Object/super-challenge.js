...
// Example Usage (change the variables names)
const merlin1 = new Hero("Merlin")
const medea1 = new Hero("Medea")
const troll1 = new Villain("Troll", 'I will destroy your soul!')
